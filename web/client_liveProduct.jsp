            ...
            <table class="layui-table">
                ...
                <c:forEach var = "p" items="${productlist}">
                    <tr id="consume">
                        ...
                        <td><button class="layui-btn layui-btn-normal" type="submit" onclick="buy(${p.product_id})" value="${p.product_id}" name="buy">购买</button></td>
                        <td><button class="layui-btn layui-btn-danger" onclick="accuse()">举报</button></td>
                    </tr>
                </c:forEach>
<%--                <form action="./sub_elecProductServlet2" method="get">--%>
                </tbody>
        ...
        <tr>
            <div align="right" style="bottom: 50px; right: 40px">
                ...
                <br>
                <a href="client_liveProductServlet?cp=1"><button class="layui-btn layui-btn-xs">首页</button></a>
                <a href="client_liveProductServlet?cp=${cpage-1 <1?1:cpage-1}"><button class="layui-btn layui-btn-xs">上一页</button></a>
                <a href="client_liveProductServlet?cp=${cpage+1>tpage?tpage:cpage+1}"><button class="layui-btn layui-btn-xs">下一页</button></a>
                <a href="client_liveProductServlet?cp=${tpage}"><button class="layui-btn layui-btn-xs">尾页</button></a>&nbsp;&nbsp;
            </div>
        </tr>
        <br><br><br><br>
    </div>
