...
<div class="layui-layout layui-layout-admin">
    ...
    <ul class="layui-nav layui-layout-left">
      ...
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          <dd><a href="./client_liveProductServlet" class="liveproduct">生活用品</a></dd>
          <dd><a href="./client_studyProductServlet" class="studyproduct">学习用品</a></dd>
          <dd><a href="./client_elecProductServlet" class="elecproduct">数码产品</a></dd>
          <dd><a href="./client_otherProductServlet" class="otherproduct">其它产品</a></dd>
        </dl>
      </li>
    </ul>
  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
      ...
      <p>
      <hr>
      <h1 align="center" style="color: #555555">校园跳蚤市场简介</h1>
      <br>
      <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        平台发展</h3><br>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        本平台诞生于2022年，旨在帮助校内学生将闲置物品变废为宝，提高物品利用效率，节约资源，解决学生
        因闲置物品没有销路或因疫情管控
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
