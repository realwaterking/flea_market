...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
            ...
            <table class="layui-table">
                ...
                <c:forEach var = "p" items="${productlist}">
                    <tr>
                        ...
                        <td><button class="layui-btn layui-btn-radius layui-btn-warm" type="submit" onclick="unsold(${p.product_id})">下架</button></td>
        ...
        <div align="right" style="bottom: 50px; right: 40px" >
            ...
            <br>
            <a href="admin_studyProductServlet?cp=1"><button class="layui-btn layui-btn-xs">首页</button></a>
            <a href="admin_studyProductServlet?cp=${cpage-1 <1?1:cpage-1}"><button class="layui-btn layui-btn-xs">上一页</button></a>
            <a href="admin_studyProductServlet?cp=${cpage+1>tpage?tpage:cpage+1}"><button class="layui-btn layui-btn-xs">下一页</button></a>
            <a href="admin_studyProductServlet?cp=${tpage}"><button class="layui-btn layui-btn-xs">尾页</button></a>&nbsp;&nbsp;
        </div>
        <br><br><br><br>
    </div>
...
<script>
    ...
    function unsold(key) {
        ...
        layer.confirm("确定下架该商品吗?", {
            ...
            yes: function (index) {
                $.ajax({
                    url: "./sub_liveProductServlet?db=22",
                    type: "get",
