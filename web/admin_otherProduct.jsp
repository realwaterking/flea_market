...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div align="right" style="bottom: 50px; right: 40px" >
            ...
            <br>
            <a href="client_otherProductServlet?cp=1"><button class="layui-btn layui-btn-xs">首页</button></a>
            <a href="client_otherProductServlet?cp=${cpage-1 <1?1:cpage-1}"><button class="layui-btn layui-btn-xs">上一页</button></a>
            <a href="client_otherProductServlet?cp=${cpage+1>tpage?tpage:cpage+1}"><button class="layui-btn layui-btn-xs">下一页</button></a>
            <a href="client_otherProductServlet?cp=${tpage}"><button class="layui-btn layui-btn-xs">尾页</button></a>&nbsp;&nbsp;
        </div>
        <br><br><br><br>
    </div>
