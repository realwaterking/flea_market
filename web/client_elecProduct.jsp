...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
            ...
            <table class="layui-table">
                ...
                <c:forEach var = "p" items="${productlist}">
                    <tr>
                        ...
                        <td><button class="layui-btn layui-btn-normal" onclick="buy(${p.product_id})" name="id">购买</button></td>
        ...
        <div align="right" style="bottom: 50px; right: 40px" >
            ...
            <br>
            <a href="client_elecProductServlet?cp=1"><button class="layui-btn layui-btn-xs">首页</button></a>
            <a href="client_elecProductServlet?cp=${cpage-1 <1?1:cpage-1}"><button class="layui-btn layui-btn-xs">上一页</button></a>
            <a href="client_elecProductServlet?cp=${cpage+1>tpage?tpage:cpage+1}"><button class="layui-btn layui-btn-xs">下一页</button></a>
            <a href="client_elecProductServlet?cp=${tpage}"><button class="layui-btn layui-btn-xs">尾页</button></a>&nbsp;&nbsp;
        </div>
        <br><br><br><br>
    </div>
