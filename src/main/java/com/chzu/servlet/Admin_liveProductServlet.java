...
@WebServlet("/admin_liveProductServlet")
public class Admin_liveProductServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("admin_liveProduct.jsp").forward(request,response);
    }
